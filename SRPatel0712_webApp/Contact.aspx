<%@ Page Title="Contact" Language="C#"  AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="SRPatel_webApp.Contact" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp"
        crossorigin="anonymous" />
    <title>Contact | Sagar Patel - Mechanical Engineer</title>
...
<body style="background-color: white; margin-right: 7%; margin-left: 7%;">
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header" style="margin-left:7%;"">
                ...
                <a href="HomePage.html" ><img style="margin-top:0%; background-color: #808080" src="images/SP.PNG" width="62px" height="50%" /></a>
            </div>
                ...
                <ul class="nav navbar-nav" style="font-weight:bolder;">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="https://www.linkedin.com/in/sagar-patel-1a1898145/" style="color:black;"><strong>LinkedIN</strong></a></li>
    ...
    <div class="container container-fluid center-block" style="background-color: white;">
        <form role="form" runat="server">
            ...
            <div class="controls">
                 <section class="hero" id="hero" style="margin-left:1%; margin-right:1%;margin-top:5%;">
                    <h2 class="hero_header1 center-block">Sagar Patel <span class="tagline light" style="font-weight: bold">Mechanical Engineer</span></h2>
        ...
        <div class="copyright" style="margin-left: 1.5%; margin-right: 1.5%;">
            &copy;2017 - <strong>Sagar Patel</strong>
        </div>
    </div>
    <!-- Main Container Ends -->
    <script src="https://code.jquery.com/jquery-3.2.1.min.js "></script>
